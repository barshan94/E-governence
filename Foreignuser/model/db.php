...
$result = $conn->query("SELECT * FROM ". $table." WHERE username='". $username."' AND Password='". $password."'");
 ...
 function UpdateUser($conn,$table,$username,$fname,$lname,$email,$age,$passport,$password)
 {
     $sql = "UPDATE $table SET FirstName='$fname', LastName='$lname', Age='$age', passport='$passport', Email='$email', Password ='$password' WHERE username='$username'";
